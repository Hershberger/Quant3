...
felm_1 <- felm(turnout_4 ~ treatment + perc_fem + perc_under30 + perc_55plus |
  state | 0 | state, data = white_district_treatment,
  weights = white_district_treatment$group_weights)
felm_2 <- felm(turnout_4 ~ treatment + perc_fem + perc_under30 + perc_55plus |
  state | 0 | state, data = black_district_treatment,
  weights = black_district_treatment$group_weights)
...
felm_4 <-felm(turnout_4 ~ treatment + perc_fem + perc_under30 + perc_55plus |
  state | 0 | state, data = latino_district_treatment,
  weights = latino_district_treatment$group_weights)
