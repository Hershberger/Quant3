...
felm_1 <- felm(turnout_4 ~ treatment + perc_fem + perc_under30 + perc_55plus |
    state | 0 | state, data = white_candidate_treatment, weights = white_candidate_treatment$group_weights)
felm_2 <- felm(turnout_4 ~ treatment + perc_fem + perc_under30 + perc_55plus |
    state | 0 | state, data = black_candidate_treatment, weights = black_candidate_treatment$group_weights)
# felm_3 <- felm(turnout_4 ~ treatment + perc_fem + perc_under30 + perc_55plus |
#     state | 0 | state, data = asian_candidate_treatment, weights = asian_candidate_treatment$group_weights)
felm_4 <-felm(turnout_4 ~ treatment + perc_fem + perc_under30 + perc_55plus |
    state | 0 | state, data = latino_candidate_treatment, weights = latino_candidate_treatment$group_weights)
