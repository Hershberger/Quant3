...
district_year_wide <- fraga_district_stats[Treatment == "Maj"]
district_year_wide[, c("TreatDist", "ControlDist") := NULL]
district_year_wide <- unique(district_year_wide, by = c("State", "PreDist",
  "PostDist", "Group"))

save(district_year, file = "data/district_year.RData")
save(district_year_wide, file = "data/district_year_wide.RData")
